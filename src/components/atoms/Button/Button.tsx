...
export const Button: FC<ButtonProps> = ({
  ...
  const sizeClasses = {
    sm: iconOnly
      ? "min-w-21 h-8 px-3 py-2 text-sm"
      : "min-w-16 h-8 px-3 py-2 text-sm",

    md: iconOnly ? "w-11 h-11 p-3" : "h-11 min-w-21 px-4 py-3 text-lg ",

    lg: iconOnly ? "w-13 h-13 p-4" : "h-13 min-w-21 p-4 text-lg  ",
  };
