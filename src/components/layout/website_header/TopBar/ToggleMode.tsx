  ...
  return (
    <>
      <label className="inline-flex items-center relative">
        ...
        <div className="relative w-[110px] h-[35px]  bg-white peer-checked:bg-zinc-500 rounded-full after:absolute after:content-[''] after:w-[35px] after:h-[35px] after:bg-gradient-to-r from-orange-500 to-yellow-400 peer-checked:after:from-zinc-900 peer-checked:after:to-zinc-900 after:rounded-full after:top-[0px] after:left-[5px] active:after:w-[35px] peer-checked:after:left-[100px] peer-checked:after:translate-x-[-100%] shadow-2xl duration-300 after:duration-300 after:shadow-md"></div>
        <svg
          height="0"
          width="100"
          viewBox="0 0 24 24"
